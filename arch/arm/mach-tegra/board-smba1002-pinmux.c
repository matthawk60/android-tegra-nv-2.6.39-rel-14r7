...
static __initdata struct tegra_pingroup_config smba1002_pinmux[] = {
	{TEGRA_PINGROUP_ATA,   TEGRA_MUX_IDE,           TEGRA_PUPD_NORMAL,    TEGRA_TRI_NORMAL},
        ...
        {TEGRA_PINGROUP_DDC,   TEGRA_MUX_SAFE,          TEGRA_PUPD_PULL_UP,   TEGRA_TRI_NORMAL},
        {TEGRA_PINGROUP_DTA,   TEGRA_MUX_SAFE,            TEGRA_PUPD_PULL_UP,   TEGRA_TRI_TRISTATE},
        ...
        {TEGRA_PINGROUP_DTE,   TEGRA_MUX_SAFE,            TEGRA_PUPD_NORMAL,    TEGRA_TRI_TRISTATE},
        ...
        {TEGRA_PINGROUP_LDI,   TEGRA_MUX_SAFE,      TEGRA_PUPD_NORMAL,    TEGRA_TRI_NORMAL},
        {TEGRA_PINGROUP_LHP0,  TEGRA_MUX_SAFE,      TEGRA_PUPD_NORMAL,    TEGRA_TRI_NORMAL},
        {TEGRA_PINGROUP_LHP1,  TEGRA_MUX_SAFE,      TEGRA_PUPD_NORMAL,    TEGRA_TRI_NORMAL},
        {TEGRA_PINGROUP_LHP2,  TEGRA_MUX_SAFE,      TEGRA_PUPD_NORMAL,    TEGRA_TRI_NORMAL},
        ...
        {TEGRA_PINGROUP_LVP1,  TEGRA_MUX_SAFE,      TEGRA_PUPD_NORMAL,    TEGRA_TRI_NORMAL},
